...
const themes: CanvasTheme[] = [
  ...
  { id: 'paper', name: '暖白纸', family: 'light', direction: '暖白纸感 + 深绿品牌色，编辑器风格', colors: { primary: '#3f6258', bg: '#f5f3ee', surface: '#fbfaf7', panel: '#f1efe9', input: '#ffffff', border: '#e0dcd2', text: '#2b2b26', muted: '#7d7a70', edge: '#3f6258' } },
  { id: 'mint', name: '薄荷青', family: 'light', direction: '清新薄荷白 + 青绿品牌色', colors: { primary: '#0f9d8c', bg: '#f0f7f6', surface: '#fbfefe', panel: '#e9f4f2', input: '#ffffff', border: '#d2e4e0', text: '#1f2e2c', muted: '#6d8a85', edge: '#0f9d8c' } },
  { id: 'rose', name: '蜜桃粉', family: 'light', direction: '柔粉白 + 玫瑰品牌色', colors: { primary: '#d65a7f', bg: '#faf3f4', surface: '#fffdfd', panel: '#f7edef', input: '#ffffff', border: '#ecd9dd', text: '#33252b', muted: '#97747d', edge: '#d65a7f' } },
